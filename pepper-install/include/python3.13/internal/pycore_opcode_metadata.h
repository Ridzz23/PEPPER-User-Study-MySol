...
int _PyOpcode_num_popped(int opcode, int oparg)  {
    switch(opcode) {
        ...
        case SET_UPDATE:
            return 2 + (oparg-1);
        case SHELL_ADD_REDIR_IN:
            return 2;
        case SHELL_ADD_REDIR_OUT:
            return 2;
        case SHELL_ADD_REDIR_OUT_APPEND:
            return 2;
        case SHELL_MERGE_PIPE:
            return 2;
        case STORE_ATTR:
            return 2;
...
const struct opcode_metadata _PyOpcode_opcode_metadata[268] = {
    ...
    [CHECK_AND_RUN_SHELL] = { true, INSTR_FMT_IX, HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
    ...
    [CLOSE_SHELL_ARGS] = { true, INSTR_FMT_IX, HAS_ESCAPES_FLAG },
    ...
    [DEBUG_DUMP_STACK] = { true, INSTR_FMT_IX, HAS_ESCAPES_FLAG },
    ...
    [PUT_ON_STACK] = { true, INSTR_FMT_IX, HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
    ...
    [SHELL_ADD_REDIR_IN] = { true, INSTR_FMT_IX, HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
    [SHELL_ADD_REDIR_OUT] = { true, INSTR_FMT_IX, HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
    [SHELL_ADD_REDIR_OUT_APPEND] = { true, INSTR_FMT_IX, HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
    [SHELL_MERGE_PIPE] = { true, INSTR_FMT_IX, HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [CHECK_AND_RUN_SHELL] = { .nuops = 1, .uops = { { _CHECK_AND_RUN_SHELL, 0, 0 } } },
    [CHECK_EG_MATCH] = { .nuops = 1, .uops = { { _CHECK_EG_MATCH, 0, 0 } } },
    [CHECK_EXC_MATCH] = { .nuops = 1, .uops = { { _CHECK_EXC_MATCH, 0, 0 } } },
    [CLOSE_SHELL_ARGS] = { .nuops = 1, .uops = { { _CLOSE_SHELL_ARGS, 0, 0 } } },
    ...
    [DEBUG_DUMP_STACK] = { .nuops = 1, .uops = { { _DEBUG_DUMP_STACK, 0, 0 } } },
    ...
    [PUT_ON_STACK] = { .nuops = 1, .uops = { { _PUT_ON_STACK, 0, 0 } } },
    ...
    [SHELL_ADD_REDIR_IN] = { .nuops = 1, .uops = { { _SHELL_ADD_REDIR_IN, 0, 0 } } },
    [SHELL_ADD_REDIR_OUT] = { .nuops = 1, .uops = { { _SHELL_ADD_REDIR_OUT, 0, 0 } } },
    [SHELL_ADD_REDIR_OUT_APPEND] = { .nuops = 1, .uops = { { _SHELL_ADD_REDIR_OUT_APPEND, 0, 0 } } },
    [SHELL_MERGE_PIPE] = { .nuops = 1, .uops = { { _SHELL_MERGE_PIPE, 0, 0 } } },
...
const char *_PyOpcode_OpName[268] = {
    ...
    [CHECK_AND_RUN_SHELL] = "CHECK_AND_RUN_SHELL",
    [CHECK_EG_MATCH] = "CHECK_EG_MATCH",
    [CHECK_EXC_MATCH] = "CHECK_EXC_MATCH",
    [CLEANUP_THROW] = "CLEANUP_THROW",
    [CLOSE_SHELL_ARGS] = "CLOSE_SHELL_ARGS",
    ...
    [SHELL_ADD_REDIR_IN] = "SHELL_ADD_REDIR_IN",
    [SHELL_ADD_REDIR_OUT] = "SHELL_ADD_REDIR_OUT",
    [SHELL_ADD_REDIR_OUT_APPEND] = "SHELL_ADD_REDIR_OUT_APPEND",
    [SHELL_MERGE_PIPE] = "SHELL_MERGE_PIPE",
