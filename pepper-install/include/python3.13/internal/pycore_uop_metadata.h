...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_DEBUG_DUMP_STACK] = HAS_ESCAPES_FLAG,
    [_PUT_ON_STACK] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_SHELL_MERGE_PIPE] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CLOSE_SHELL_ARGS] = HAS_ESCAPES_FLAG,
    [_SHELL_ADD_REDIR_OUT] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_SHELL_ADD_REDIR_OUT_APPEND] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_SHELL_ADD_REDIR_IN] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CHECK_AND_RUN_SHELL] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_CHECK_AND_RUN_SHELL] = "_CHECK_AND_RUN_SHELL",
    ...
    [_CLOSE_SHELL_ARGS] = "_CLOSE_SHELL_ARGS",
    ...
    [_DEBUG_DUMP_STACK] = "_DEBUG_DUMP_STACK",
    ...
    [_SHELL_ADD_REDIR_IN] = "_SHELL_ADD_REDIR_IN",
    [_SHELL_ADD_REDIR_OUT] = "_SHELL_ADD_REDIR_OUT",
    [_SHELL_ADD_REDIR_OUT_APPEND] = "_SHELL_ADD_REDIR_OUT_APPEND",
    [_SHELL_MERGE_PIPE] = "_SHELL_MERGE_PIPE",
...
int _PyUop_num_popped(int opcode, int oparg)
{
    switch(opcode) {
        ...
        case _DICT_MERGE:
            return 5 + (oparg - 1);
        case _DEBUG_DUMP_STACK:
            return 0;
        case _PUT_ON_STACK:
            return 2;
        case _SHELL_MERGE_PIPE:
            return 2;
        case _CLOSE_SHELL_ARGS:
            return 1;
        case _SHELL_ADD_REDIR_OUT:
            return 2;
        case _SHELL_ADD_REDIR_OUT_APPEND:
            return 2;
        case _SHELL_ADD_REDIR_IN:
            return 2;
        case _CHECK_AND_RUN_SHELL:
            return 1;
        case _MAP_ADD:
            return 3 + (oparg - 1);
