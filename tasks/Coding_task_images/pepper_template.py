...
#TODO 3: find all the files that end with .jpg in the images folder and create a python list of all the file names (FS)
# provide an example of how the file path should look. 


#TODO 4: iterate through the list of filenames and for each image apply the heat_map filter. 
# Also keep track of the running sum of img widths and heights and num_img_files_processed. (FS)
...
#TODO 5: calculate the total number of files in the images folder and the average width of all jpg image files. (DATA) - REMOVE
tot_files = 0 #TODO
...
#TODO 6: Write report_str to the file report.txt. 
# The file report.txt should be located outside the images folder and should be directly under the Coding_task_images folder. (FS)
