...
# potential reading tasks:
# 1. change the code to grab all the earthquakes in Utah
# 2. 
...
#
# earthquakes
# which must be a dictionary with the key and value pairs like json file - SPECIFY
#
# (DATA)
